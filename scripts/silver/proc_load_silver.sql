...
/*
	This stored procedure is responsible for loading data from the bronze layer to the silver layer in the Data Warehouse. 
	It performs necessary data transformations and cleansing operations to ensure data quality in the silver layer. 
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> TRUNCATE TABLE: silver.erp_az12';
		TRUNCATE TABLE silver.erp_az12;


		PRINT '>> Inserting Data Into: silver.erp_az12';
